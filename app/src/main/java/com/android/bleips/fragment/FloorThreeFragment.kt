...
import kotlinx.android.synthetic.main.fragment_floor_three.*
...
class FloorThreeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        rootLayout = inflater.inflate(R.layout.fragment_floor_three, container, false)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        floors = resources.getStringArray(R.array.floor_three)
